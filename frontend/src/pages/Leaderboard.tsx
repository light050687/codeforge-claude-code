...
import { useFastestSolutions } from '../hooks/useSolutions'
...
export default function Leaderboard() {
  ...
  const isLoading = activeTab === 'authors' ? loadingUsers : loadingSolutions
  const error = activeTab === 'authors' ? usersError : solutionsError
  const refetch = activeTab === 'authors' ? refetchUsers : refetchSolutions
            ...
            <table className="w-full">
              ...
              <tbody className="divide-y divide-bg-tertiary">
                {isLoading ? (
                  ...
                  <tr>
                    <td colSpan={4}>
                      <EmptyState message="Category rankings coming soon" />
                    </td>
                  </tr>
                )}
              </tbody>
