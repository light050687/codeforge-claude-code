      ...
      <header className="sticky top-0 z-50 border-b border-bg-tertiary bg-bg-primary/80 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            {/* Auth */}
            {isLoading ? (
              <div className="w-32 h-9 bg-bg-tertiary rounded-lg animate-pulse" />
              ...
              <button
                onClick={login}
                className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-accent-primary rounded-lg hover:bg-accent-primary/90 transition-colors"
              >
